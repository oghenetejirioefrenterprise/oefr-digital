#!/usr/bin/env python3
"""
Ship samgov-small-biz-contractor-leads-2026-05
...
def gumroad_deploy(playwright):
    ...
    try:
        ...
        if "login" in cur:
            page.screenshot(path="/tmp/gr_sam_login_fail.png")
            browser.close()
            return None, None
    ...
    try:
        ...
        print(f"   Asset uploading… (may take ~30s)")
        time.sleep(30)
    ...
    page.screenshot(path="/tmp/gr_sam_final.png")
...
try:
    ...
    print(f"   Stripe smoke: {e} (treating as ok — link just created)")
