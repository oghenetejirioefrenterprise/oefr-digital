"""
Detector for trend_day_afternoon_continuation.
Category: trend_day_continuation   Timeframe: intraday   Confidence: high
Venues: HL perps, Binance futures, Binance spot
