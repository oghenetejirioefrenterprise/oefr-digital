...
- Commit prefix: `feat(cycle-trader):` / `test(cycle-trader):`. The git root is `~/apps`; scope commits to `cycle-trader/`.
...
```bash
cd ~/apps
git add cycle-trader/pyproject.toml cycle-trader/engine cycle-trader/tests
...
```bash
cd ~/apps
git add cycle-trader/engine/bars.py cycle-trader/tests/test_bars.py
...
```bash
cd ~/apps
git add cycle-trader/engine/rsi.py cycle-trader/tests/test_rsi.py
...
```bash
cd ~/apps
git add cycle-trader/data cycle-trader/engine/lines.py cycle-trader/tests/test_lines.py
...
```bash
cd ~/apps
git add cycle-trader/engine/fills.py cycle-trader/tests/test_fills.py
...
```bash
cd ~/apps
git add cycle-trader/engine/lifecycle.py cycle-trader/tests/test_lifecycle.py
...
```bash
cd ~/apps
git add cycle-trader/engine/structure.py cycle-trader/tests/test_structure.py
...
```bash
cd ~/apps
git add cycle-trader/engine/levels.py cycle-trader/tests/test_levels.py
...
```bash
cd ~/apps
git add cycle-trader/engine/orders.py cycle-trader/tests/test_orders.py
...
```bash
cd ~/apps
git add cycle-trader/tests/gates
...
```bash
cd ~/apps
git add cycle-trader/engine/structure.py cycle-trader/tests/gates
...
```bash
cd ~/apps
git add cycle-trader/tests/gates/test_regression_ep2_ep5.py
...
this directory. A workflow file under `cycle-trader/.github/` would sit
...
Run: `cd ~/apps/cycle-trader && pytest -v`
...
```bash
cd ~/apps
git add cycle-trader/tests/gates/test_oq3_synthetic.py .github/workflows/cycle-trader-gates.yml
...
```bash
cd ~/apps
git add cycle-trader/engine/engine.py cycle-trader/tests/test_engine.py cycle-trader/tests/conftest.py
