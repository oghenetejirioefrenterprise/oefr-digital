"""
Detector for multi_timeframe_retest_alignment.
Category: second_chance_retest   Timeframe: swing   Confidence: high
Venues: HL perps (BTC, ETH, SOL), Binance spot (long-bias), Binance futures (USDⓈ-M)
