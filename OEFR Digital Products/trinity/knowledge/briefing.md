...
### Top open issues
  - [2026-04-22] airbnb-turnover-sop-pack — SUPERSEDED 2026-05-24: airbnb-sop killed May 4. Tab inventory mismatch moot on d
  - [2026-04-22] debt-lawsuit-answer-kit — SUPERSEDED 2026-05-24: debt-lawsuit cascade-killed May 6. Spec ambiguity moot on 
  - [2026-04-22] etsy-stats-scrape — Etsy stats-page scraper (sensor) returns 0 listing IDs on 01:36 + 09:32 Apr 21 runs eve
  - [2026-04-21] etsy-shop — RESOLVED 2026-05-18 22:09 ET per TJ ruling + 4 favorites/7d: CATEGORY-KILL CANCELLED. Duplicate
...
Use `python trinity/knowledge/cli.py query <topic>` to search.
Use `python trinity/knowledge/cli.py log-issue|log-audit|signal` to write.
